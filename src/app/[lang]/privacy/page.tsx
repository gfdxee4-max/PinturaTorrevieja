...
import { dictionaries, isLocale, locales, type Locale } from "@/config/i18n";
...
export async function generateMetadata({ params }: PrivacyPageProps): Promise<Metadata> {
  ...
  return { title: privacyTranslations[lang].title, robots: { index: true, follow: true }, alternates: { canonical: `/${lang}/privacy` } };
}
