...
export const dictionaries = {
  es: {
    ...
    hero: {
      ...
      text: "PaintLab, también conocido como Pintura Torrevieja, es un taller de carrocería en Torrevieja, Alicante, especializado en pintura de coche, reparación de chapa y reparación de carrocería.",
  ...
  ru: {
    ...
    description: "Автопокраска и кузовной ремонт в Торревьехе: локальная и полная покраска автомобиля, ремонт деталей после ДТП. Расчёт стоимости по фото в WhatsApp.",
    ...
    hero: {
      ...
      text: "PaintLab — мастерская ремонта и покраски автомобилей в Торревьехе. Восстанавливаем повреждённые кузовные детали, выполняем подготовку и окраску, показываем реальные работы и помогаем выбрать подходящую услугу.",
  ...
  uk: {
    ...
    hero: {
      ...
      text: "PaintLab — автомалярна майстерня в місті Торрев’єха, де виконують фарбування авто, кузовний ремонт і підготовку поверхні автомобіля.",
