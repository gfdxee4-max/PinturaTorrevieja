...
export const dictionaries = {
  ...
  ru: {
    ...
    hero: {
      ...
      text: "PaintLab — автомалярная мастерская в Торревьехе. Выполняем автопокраску, покраску автомобилей и кузовной ремонт: восстанавливаем повреждённые детали кузова и готовим автомобиль к окраске.",
