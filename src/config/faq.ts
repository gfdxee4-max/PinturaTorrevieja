  ...
  ru: [
    {
      ...
      answer: "Стоимость зависит от площади повреждения, состояния поверхности, объёма подготовки и выбранного варианта покраски. Для предварительного расчёта отправьте фотографии автомобиля в WhatsApp; точную стоимость согласуем после осмотра.",
    },
    {
      question: "Можно ли отправить фотографии в WhatsApp?",
      answer: "Да. Снимите повреждение с нескольких ракурсов и укажите модель автомобиля. По фотографиям мы предварительно оценим ремонт, а окончательный объём работ подтвердим после осмотра.",
    },
    {
      question: "Делаете ли вы ремонт после ДТП?",
      answer: "Да, выполняем кузовной ремонт после ДТП: восстанавливаем повреждённые элементы, устраняем вмятины и царапины, подготавливаем поверхность и окрашиваем необходимые детали.",
    },
    {
      question: "Красите ли вы отдельные детали кузова?",
      answer: "Да, можно заказать локальную покраску или окраску отдельной детали — бампера, крыла, двери или капота. Также выполняем полную покраску автомобиля, если этого требует состояние кузова.",
    },
    {
      question: "Сколько длится кузовной ремонт?",
      answer: "Срок зависит от характера повреждений, количества деталей и объёма подготовки. После осмотра мы согласуем перечень работ и ориентировочный срок до начала ремонта.",
    },
    {
      question: "Работаете ли вы со страховыми компаниями?",
      answer: "Возможность работы с документами страховой компании зависит от конкретного случая. Перед записью сообщите, какая страховая ведёт дело и какие документы уже оформлены.",
    },
  ],
  uk: [
    {
